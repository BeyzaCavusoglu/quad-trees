I implement a slightly more complex version of binary search trees which are quad trees. Remember that binary search trees typically work on one dimensional key spaces.
